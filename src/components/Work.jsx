...
import workImage1 from '../assets/my portfolio.png'
...
shadow-lg shadow-[#040c16] group counter rounded-md flex justify-center items-center
mx-auto content-div h-[200px] bg-cover relative'>
<img src={workImage1} layout='fill'objectFit='cover' alt=''/>
<div className='opacity-0 group-hover:opacity-90 bg-[gray]/70 absolute inset-0 flex flex-col 
justify-center items-center'>
    <span className='text-2xl font-bold text-white tracking-wider'></span>
    <div className='pt-8 text-center'>
<a href='https://icbportfolio.netlify.app/'>
